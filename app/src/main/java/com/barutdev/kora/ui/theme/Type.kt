...
/**
 * Kora Typography - Material 3 Type Scale
 * 
 * Full implementation of Material Design 3 typography for consistent,
 * professional text styling across the entire application.
 */
